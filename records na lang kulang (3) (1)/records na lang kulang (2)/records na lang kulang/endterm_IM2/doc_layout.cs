        ...
        private void button_back_Click(object sender, EventArgs e)
        {
            ...
            else if (this.button_back.Text == "Edit")
            {
               ...
               add_patient_student1.first_Name.Clear();
                ...
                add_patient_student1.first_Name.Text = doc_manage_patient1.manage_fname;
                add_patient_student1.last_Name.Text = doc_manage_patient1.manage_lname;
                add_patient_student1.age.Text = doc_manage_patient1.manage_age;
             
                add_patient_student1.contact_number.Text = doc_manage_patient1.manage_contact_num;
                add_patient_student1.address.Text = doc_manage_patient1.manage_address;
                add_patient_student1.course.Text = doc_manage_patient1.manage_program_course;
                add_patient_student1.parent_address.Text = doc_manage_patient1.manage_emer_contat_address;
                add_patient_student1.address.Text = doc_manage_patient1.manage_address ;
                add_patient_student1.parent_Contact.Text = doc_manage_patient1.manage_emer_contact_num;
                add_patient_student1.parent_Name.Text = doc_manage_patient1.manage_emer_contact_name;
            }
        }
